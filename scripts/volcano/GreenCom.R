...
"
green_peak_areas_Com <- green_peak_areas |> 
...
green_peak_areas_with_stats <- green_peak_areas |> 
  left_join(
    green_volcano_stats,
...
green_peak_areas_with_stats <- green_peak_areas_with_stats |> 
...
green_peak_areas_with_stats$diffexpressed <- "Insignificant"
green_peak_areas_with_stats$diffexpressed[green_peak_areas_with_stats$log2fc > 0.4 & green_peak_areas_with_stats$p_value < 0.05] <- "Up Regulated"
green_peak_areas_with_stats$diffexpressed[green_peak_areas_with_stats$log2fc < -0.4 & green_peak_areas_with_stats$p_value < 0.05] <- "Down Regulated"

mycolors <- c("blue", "red", "grey")
names(mycolors) <- c("Down Regulated", "Up Regulated", "Insignificant")

green_peak_areas_with_stats$delabel <- NA
green_peak_areas_with_stats$delabel[green_peak_areas_with_stats$diffexpressed != "Insignificant"] <- green_peak_areas_with_stats$rt_label[green_peak_areas_with_stats$diffexpressed != "Insignificant"]

plot_df <- green_peak_areas_with_stats |>
...
p <- ggplot(data = plot_df, 
  ...
  labs(
    title = "Green Sagebrush with CYP+UGT Enzymes",
...
ggsave('./images/volcano/GreenCom.png', p, width = 6, height = 4, units = 'in', dpi = 600)
