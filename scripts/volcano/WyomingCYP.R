...
"
wyoming_peak_areas_CYP <- wyoming_peak_areas |> 
...
wyoming_volcano_stats <- wyoming_peak_areas_CYP |> 
...
p <- ggplot(data = plot_df, 
  ...
  labs(
    title = "Wyoming Sagebrush with CYP Enzyme",
...
ggsave('./images/volcano/WyomingCYP.png', p, width = 6, height = 4, units = 'in', dpi = 600)
