...
"
white_peak_areas_UGT <- white_peak_areas |> 
...
white_volcano_stats <- white_peak_areas_UGT |> 
...
p <- ggplot(data = plot_df, 
  ...
  labs(
    title = "White Sagebrush with UGT Enzyme",
...
ggsave('./images/volcano/WhiteUGT.png', p, width = 6, height = 4, units = 'in', dpi = 600)
