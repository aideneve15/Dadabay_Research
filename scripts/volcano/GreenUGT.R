...
"
green_peak_areas_UGT <- green_peak_areas |> 
...
green_volcano_stats <- green_peak_areas_UGT |> 
...
p <- ggplot(data = plot_df, 
  ...
  labs(
    title = "Green Sagebrush with UGT Enzyme",
...
ggsave('./images/volcano/GreenUGT.png', p, width = 6, height = 4, units = 'in', dpi = 600)
