...
"
white_peak_areas_Com <- white_peak_areas |> 
...
white_volcano_stats <- white_peak_areas_Com |> 
...
p <- ggplot(data = plot_df, 
  ...
  labs(
    title = "White Sagebrush with CYP+UGT Enzyme",
...
ggsave('./images/volcano/WhiteCom.png', p, width = 6, height = 4, units = 'in', dpi = 600)
