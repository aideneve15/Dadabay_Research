...
"
green_peak_areas_CYP <- green_peak_areas |> 
...
green_volcano_stats <- green_peak_areas_CYP |> 
...
p <- ggplot(data = plot_df, 
  ...
  labs(
    title = "Green Sagebrush with CYP Enzyme",
...
ggsave('./images/volcano/GreenCYP.png', p, width = 6, height = 4, units = 'in', dpi = 600)
